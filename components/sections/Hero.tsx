  ...
  return (
    <header className="grid w-full grid-cols-1 lg:min-h-[calc(100svh-3rem)]">
      <section className="hero-panel terminal-card w-full overflow-hidden border-term-border lg:flex lg:h-full lg:flex-col">
        ...
        <div className="flex h-[58svh] flex-col px-3 pb-4 pt-2 text-sm leading-6 sm:h-[60vh] sm:px-6 sm:pb-6 sm:pt-3 sm:text-base sm:leading-7 lg:h-auto lg:min-h-0 lg:flex-1 lg:pb-8 lg:pt-4">
          <div className="mx-auto flex w-full max-w-[72ch] flex-1 flex-col">
            <div className="mb-5 min-w-0">
              <PromptLine text="whoami" />
            </div>

            <div className="mb-5 rounded-lg border border-term-green/35 bg-term-green/10 px-3 py-3">
              <h1 className="pl-2 text-2xl font-semibold text-term-green sm:text-4xl">Marcelo Apolinário</h1>
            </div>

            <div className="mb-5 rounded-lg border border-term-cyan/30 bg-term-cyan/5 px-3 py-3">
              <p className="pl-2 text-sm font-medium tracking-[0.02em] text-term-cyan sm:text-lg">DevOps &amp; Networking Engineer</p>
            </div>

            <p className="mb-6 pl-2 text-slate-300">Provisiono ambientes resilientes e escaláveis.</p>
