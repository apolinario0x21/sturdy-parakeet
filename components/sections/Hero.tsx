...
export function Hero() {
  return (
    <header className="h-[100svh] min-h-[620px]">
      <TerminalWindow title="~/home" className="hero-panel flex h-full flex-col border-term-border">
        <div className="mx-auto flex h-full w-full max-w-5xl flex-1 flex-col justify-between gap-8 p-2 sm:p-4">
          ...
          <div className="grid items-stretch gap-4 md:grid-cols-[1.4fr_1fr]">
            <p className="terminal-output flex h-full items-start text-base text-slate-200 sm:text-xl">
