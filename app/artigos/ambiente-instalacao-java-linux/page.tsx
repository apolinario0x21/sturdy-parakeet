...
const stackItems: StackItem[] = [
  { icon: 'JDK', title: 'Java (JDK)', subtitle: 'OpenJDK 21 LTS' },
  { icon: 'MVN', title: 'Maven', subtitle: 'via apt' },
  { icon: 'IDE', title: 'IntelliJ IDEA', subtitle: 'Community / Ultimate' },
  { icon: 'PG', title: 'PostgreSQL', subtitle: '17 (PGDG)' },
  { icon: 'ADM', title: 'pgAdmin 4', subtitle: 'desktop + web' },
  { icon: 'API', title: 'Postman', subtitle: 'via Snap' },
  { icon: 'VCS', title: 'Git', subtitle: 'via apt' }
];
...
export const metadata: Metadata = {
  ...
  description:
    'Guia prático para configurar Java 21, Maven, IntelliJ, PostgreSQL 17, pgAdmin, Postman e Git no Ubuntu 24.04.'
};
...
const articleLd = {
  ...
  description:
    'Passo a passo para instalação de Java 21, Maven, IntelliJ, PostgreSQL 17, pgAdmin, Postman e Git em Ubuntu 24.04.',
  author: {
    '@type': 'Person',
  ...
  mainEntityOfPage: '/artigos/ambiente-instalacao-java-linux'
};
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {stackItems.map((item) => (
                <div key={item.title} className="rounded-xl border border-term-border/70 bg-term-panel/40 px-4 py-3">
                  <p className="text-sm font-semibold text-term-cyan">{item.icon}</p>
